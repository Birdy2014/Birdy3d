...
namespace Birdy3d {
    ...
    public:
        ...
        void renderText(std::string text, float x, float y, float fontSize, Color color, glm::mat4 move, float cutTop = 0, float cutBottom = -INFINITY, int cursorpos = -1, int hlstart = -1, int hlend = -1, Color hlcolor = Color::BLACK);
