...
namespace Birdy3d {
    ...
    Theme::Theme(Color color_fg, Color color_bg, Color color_border, Color color_title_bar, Color color_input_bg, Color color_selected_bg, Color color_text_highlight, std::string font, int font_size)
        : color_fg(color_fg)
        , color_bg(color_bg)
